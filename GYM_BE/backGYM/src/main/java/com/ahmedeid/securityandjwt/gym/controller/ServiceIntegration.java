...
public class ServiceIntegration {
    ...
    @GetMapping("/changePlayerSubscriptionsStrategy/{subtypeId}/{code}")
    public Player changePlayerSubscriptionsStrategy(@PathVariable long subtypeId,
                                                    @PathVariable long code) {
        return this.playerService.changePlayerSubscriptionsStrategy(subtypeId, code);
    }
